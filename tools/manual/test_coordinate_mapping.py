...
class CoordinateCalibrationOverlay(QWidget):
    def __init__(self):
        ...
        self.shapes = [
            RectangleShape(
                x=0, y=0, width=box_size, height=box_size, padding=padding, outline_color="red"
            ),  # Top-Left
            RectangleShape(
                x=w - box_size,
                y=0,
        ...
        print(
            "Please visually verify that the 5 colored boxes are perfectly aligned in the 4 corners and the center of your screen."
        )
